...
public class Beneficiary {
	...
	@JsonProperty(access = Access.WRITE_ONLY)//added to get list of beneficiaries associated to an account otherwise accounts related to particular beneficiary was also coming
